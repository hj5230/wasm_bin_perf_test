const { string_to_md5, fib, fib_iter } = require('./pkg/test_rust.js');
...
// const res = fib(40)
// quick_sort([1, 3, 4, 2, 9, 0, 3, 5, 8, 4, 9 ,4, 8, 2, 1, 4, 1, 3, 4, 2, 9, 0, 3, 5, 8, 4, 9 ,4, 8, 2, 1, 4, 1, 3, 4, 2, 9, 0, 3, 5, 8, 4, 9 ,4, 8, 2, 1, 4, 5, 8, 4, 9 ,4, 8, 2, 1, 4, 1, 3, 4, 2, 9, 0, 3, 5, 8, 4, 9 ,4, 8, 2, 1, 4, 1, 3, 4, 2, 9, 0])
...
const resRecu = fib(40)
const endRecu = performance.now()

const startIter = performance.now()
const resIter = fib_iter(40)
const endIter = performance.now()

const startNodeRecu = performance.now()
const resNodeRecu = fib_node_re(40)
const endNodeRecu = performance.now()

const startNodeIter = performance.now()
const resNodeIter = fib_node_it(40)
const endNodeIter = performance.now()
...
console.log("Node Recursive time:", `${endNodeRecu - startNodeRecu} ms`);
console.log("Node Recursive:", resNodeRecu);
console.log("Node Iterative time:", `${endNodeIter - startNodeIter} ms`);
console.log("Node Iterative:", resNodeIter);
